...
4. **Sandbox Execution Layer:** A dedicated environment that executes code, runs tests (`pytest`), lints (`ruff`), and performs static analysis (`mypy`) to validate the generated patches before they go to review.
